...
public class RectangularView extends View {
    ...
    public RectangularView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RectangularView);
        if (ta != null) {
            mCount = ta.getInt(R.styleable.RectangularView_count, 6);
            ta.recycle();
        }
    }
